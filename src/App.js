import { Button, colors, CssBaseline, IconButton, Input, Typography, useTheme } from '@mui/material'
			...
			<Box className='app'>
				...
				>
					...
					>
						...
						>
							...
							>
								The farm project consists of one acre plots roughly costing from 10
								to 20 lakhs.
							</Typography>
				...
				>
					...
					>
						...
						>
							<Box className='forOpacity1' sx={{ gridRow: '1', gridColumn: '1' }}>
								<Typography
								...
								>
									Lorem ipsum dolor sit aor leggo sit amit deur sit amet lorenzom
								</Typography>
							</Box>

							<Box className='forOpacity1' sx={{ gridRow: '1', gridColumn: '2' }}>
								<Typography
									sx={{ fontWeight: 900, fontSize: 27 }}
									className='footer-header'
								>
							...
							<Box className='forOpacity1' sx={{ gridRow: '2', gridColumn: '1' }}>
								<Typography
									sx={{
										fontWeight: 900,
										fontSize: 27,
							...
							<Box className='forOpacity1' sx={{ gridRow: '2', gridColumn: '2' }}>
								<Typography
									sx={{ fontWeight: 900, fontSize: 27 }}
									className='footer-header'
								>
							...
							<Box className='forOpacity1' sx={{ gridRow: '1/3', gridColumn: '3' }}>
								<Typography
									sx={{ fontWeight: 900, fontSize: 27 }}
									className='footer-header'
								>
